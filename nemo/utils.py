...
def multiproc(func, iterator_keys, n_procs = None, **kwargs):
    '''
...
def multithread(func, iterator_keys, n_procs = None, **kwargs):
    '''
    A general function to use multithreading for IO-bound operations. 
